...
import com.nbatch.job.admin.core.model.XxlJobLogReport;
            ...
            while (!toStop) {
                ...
                try {
                    ...
                    for (int i = 0; i < 3; i++) {
                        ...
                        if (CollUtil.isNotEmpty(triggerCountMap)) {
                            ...
                            int triggerDayCountRunning = triggerCountMap.containsKey("triggerDayCountRunning") ?
                                    Integer.parseInt(String.valueOf(triggerCountMap.get("triggerDayCountRunning"))) : 0;
                            int triggerDayCountSuc = triggerCountMap.containsKey("triggerDayCountSuc") ?
                                    Integer.parseInt(String.valueOf(triggerCountMap.get("triggerDayCountSuc"))) : 0;
