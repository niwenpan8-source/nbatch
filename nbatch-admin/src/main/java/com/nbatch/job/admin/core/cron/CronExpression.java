...
package com.nbatch.job.admin.core.cron;
...
public final class CronExpression implements Serializable, Cloneable {
    ...
    private void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            boolean dayOfMSpec = !CollUtil.contains(dom, NO_SPEC);
            boolean dayOfWSpec = !CollUtil.contains(dow, NO_SPEC);
    ...
    private int storeExpressionVals(String s, int type)
        ...
        char c = s.charAt(i);
        if ((c >= 'A') && (c <= 'Z') && (!StrUtil.equals(s, "L")) && (!StrUtil.equals(s, "LW")) && (!s.matches("^L-[0-9]*[W]?"))) {
    ...
    public Date getTimeAfter(Date afterTime) {
        ...
        while (!gotOne) {
            ...
            if (dayOfMSpec && !dayOfWSpec) {
                ...
                } else if (CollUtil.isNotEmpty(st)) {
                    t = day;
                    day = st.first();
